...
struct string {
  ...
  bool operator<(std::string const &rhs) const { return impl_ < rhs; }
  bool operator>(std::string const &rhs) const { return impl_ > rhs; }
  bool operator==(std::string const &rhs) const { return impl_ == rhs; }
  bool operator!=(std::string const &rhs) const { return impl_ != rhs; }
  char &operator[](size_t i) { return impl_[i]; }
  char const &operator[](size_t i) const { return impl_[i]; }
  ...
  void insert(size_t pos, size_t n, char ch) { impl_.insert(pos, n, ch); }
  void insert(size_t pos, std::initializer_list<char> il) {
    impl_.insert(pos, il);
  }
  ...
  //friend string operator+(string const &lhs, string const &rhs) { return lhs.impl_ + rhs.impl_; }
